...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/samm043" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/md-sameer-333341318?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" },
  { icon: Instagram, link: "https://www.instagram.com/______samm_?igsh=MTRkeWdmNGVwOGhrMQ==" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  The website is a dynamic,forward-thinkinkg,efficient,and purpose-driven digital
                  solution designed for lasting impact.
                </p>
