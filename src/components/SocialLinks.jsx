...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/md-sameer-333341318?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@mdsameer",
    icon: Instagram,
    url: "https://www.instagram.com/______samm_?igsh=MTRkeWdmNGVwOGhrMQ==",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@mdsameer",
    icon: Youtube,
    url: "https://youtube.com/@cristiano-2x?si=ULLuxWgphkrJUB-a",
    color: "#FF0000",
